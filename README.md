...
De plus, il y a des unités avec des + (Exemple :"I4+ Gardes Bolton"). Cela correspond juste que ces troupes sont entre deux niveaux donc j'ai choisi de les mettres au plus petit niveau des deux mais en ajoutant un +.